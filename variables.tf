...
variable "enable_nat_gateway" {
  description = "Should be true if you want to provision NAT Gateways for each of your private networks, the number of AZs must to be equal to the number of private subnets"
  type        = bool
  default     = false
}
